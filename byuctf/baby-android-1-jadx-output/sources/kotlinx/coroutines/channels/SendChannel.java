...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo1669trySendJP2dKIU(e);
            if (ChannelResult.m1684isSuccessimpl(result)) {
                return true;
            }
            Throwable m1678exceptionOrNullimpl = ChannelResult.m1678exceptionOrNullimpl(result);
