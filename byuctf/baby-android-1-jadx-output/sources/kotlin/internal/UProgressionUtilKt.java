...
public final class UProgressionUtilKt {
    ...
    private static final int m1380differenceModuloWZ9TVnA(int a, int b, int c) {
        ...
        return UInt.m257constructorimpl(Integer.compareUnsigned(ac, bc) >= 0 ? ac - bc : UInt.m257constructorimpl(ac - bc) + c);
    }
    ...
    private static final long m1381differenceModulosambcqE(long a, long b, long c) {
        ...
        return ULong.m336constructorimpl(Long.compareUnsigned(ac, bc) >= 0 ? ac - bc : ULong.m336constructorimpl(ac - bc) + c);
    }
    ...
    public static final int m1383getProgressionLastElementNkh28Cs(int start, int end, int step) {
        if (step > 0) {
            if (Integer.compareUnsigned(start, end) < 0) {
                return UInt.m257constructorimpl(end - m1380differenceModuloWZ9TVnA(end, start, UInt.m257constructorimpl(step)));
            }
        } else {
            if (step >= 0) {
            ...
            if (Integer.compareUnsigned(start, end) > 0) {
                return UInt.m257constructorimpl(m1380differenceModuloWZ9TVnA(start, end, UInt.m257constructorimpl(-step)) + end);
            }
        }
        return end;
    }
    ...
    public static final long m1382getProgressionLastElement7ftBX0g(long start, long end, long step) {
        if (step > 0) {
            if (Long.compareUnsigned(start, end) < 0) {
                return ULong.m336constructorimpl(end - m1381differenceModulosambcqE(end, start, ULong.m336constructorimpl(step)));
            }
        } else {
            if (step >= 0) {
                throw new IllegalArgumentException("Step is zero.");
            ...
            if (Long.compareUnsigned(start, end) > 0) {
                return ULong.m336constructorimpl(m1381differenceModulosambcqE(start, end, ULong.m336constructorimpl(-step)) + end);
            }
        }
        return end;
    }
