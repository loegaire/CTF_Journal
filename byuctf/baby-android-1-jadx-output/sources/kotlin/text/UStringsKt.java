...
public final class UStringsKt {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compareUnsigned(data, UInt.m257constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m174boximpl(UByte.m180constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m257constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m257constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m257constructorimpl(result * uradix);
            result = UInt.m257constructorimpl(UInt.m257constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m251boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m336constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m336constructorimpl(result * uradix);
            result = ULong.m336constructorimpl(ULong.m336constructorimpl(UInt.m257constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m330boximpl(result);
    }
}
