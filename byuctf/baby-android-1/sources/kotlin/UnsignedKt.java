...
public final class UnsignedKt {
    ...
    public static final int m513uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m257constructorimpl((int) ((v1 & 4294967295L) / (4294967295L & v2)));
    }

    /* renamed from: uintRemainder-J1ME1BU, reason: not valid java name */
    public static final int m514uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m257constructorimpl((int) ((v1 & 4294967295L) % (4294967295L & v2)));
    }

    /* renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m515ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m336constructorimpl(Long.compareUnsigned(v1, v2) >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
            return ULong.m336constructorimpl(v1 / v2);
        }
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        return ULong.m336constructorimpl((Long.compareUnsigned(ULong.m336constructorimpl(rem), ULong.m336constructorimpl(v2)) < 0 ? 0 : 1) + quotient);
    }

    /* renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m516ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
        ...
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        if (Long.compareUnsigned(ULong.m336constructorimpl(rem), ULong.m336constructorimpl(v2)) >= 0) {
            j = v2;
        }
        return ULong.m336constructorimpl(rem - j);
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        return v <= 2.147483647E9d ? UInt.m257constructorimpl((int) v) : UInt.m257constructorimpl(UInt.m257constructorimpl((int) (v - Integer.MAX_VALUE)) + UInt.m257constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        ...
        return v < 9.223372036854776E18d ? ULong.m336constructorimpl((long) v) : ULong.m336constructorimpl(ULong.m336constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
