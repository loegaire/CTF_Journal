...
public class URangesKt___URangesKt {
    ...
    public static final UInt firstOrNull(UIntProgression $this$firstOrNull) {
        ...
        return UInt.m251boximpl($this$firstOrNull.getFirst());
    }
    ...
    public static final ULong firstOrNull(ULongProgression $this$firstOrNull) {
        ...
        return ULong.m330boximpl($this$firstOrNull.getFirst());
    }
    ...
    public static final UInt lastOrNull(UIntProgression $this$lastOrNull) {
        ...
        return UInt.m251boximpl($this$lastOrNull.getLast());
    }
    ...
    public static final ULong lastOrNull(ULongProgression $this$lastOrNull) {
        ...
        return ULong.m330boximpl($this$lastOrNull.getLast());
    }
    ...
    public static final UInt randomOrNull(UIntRange $this$randomOrNull, Random random) {
        ...
        return UInt.m251boximpl(URandomKt.nextUInt(random, $this$randomOrNull));
    }
    ...
    public static final ULong randomOrNull(ULongRange $this$randomOrNull, Random random) {
        ...
        return ULong.m330boximpl(URandomKt.nextULong(random, $this$randomOrNull));
    }
    ...
    public static final boolean m1429contains68kG9v0(UIntRange contains, byte value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1402containsWZ4Q5Ns(UInt.m257constructorimpl(value & UByte.MAX_VALUE));
    }

    /* renamed from: contains-ULb-yJY, reason: not valid java name */
    public static final boolean m1432containsULbyJY(ULongRange contains, byte value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1411containsVKZWuLQ(ULong.m336constructorimpl(value & 255));
    }

    /* renamed from: contains-Gab390E, reason: not valid java name */
    public static final boolean m1431containsGab390E(ULongRange contains, int value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1411containsVKZWuLQ(ULong.m336constructorimpl(value & 4294967295L));
    }

    /* renamed from: contains-fz5IDCE, reason: not valid java name */
    public static final boolean m1435containsfz5IDCE(UIntRange contains, long value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return ULong.m336constructorimpl(value >>> 32) == 0 && contains.m1402containsWZ4Q5Ns(UInt.m257constructorimpl((int) value));
    }

    /* renamed from: contains-ZsK3CEQ, reason: not valid java name */
    public static final boolean m1433containsZsK3CEQ(UIntRange contains, short value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1402containsWZ4Q5Ns(UInt.m257constructorimpl(65535 & value));
    }

    /* renamed from: contains-uhHAxoY, reason: not valid java name */
    public static final boolean m1436containsuhHAxoY(ULongRange contains, short value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1411containsVKZWuLQ(ULong.m336constructorimpl(value & 65535));
    }

    /* renamed from: downTo-Kr8caGY, reason: not valid java name */
    public static final UIntProgression m1439downToKr8caGY(byte $this$downTo_u2dKr8caGY, byte to) {
        return UIntProgression.INSTANCE.m1399fromClosedRangeNkh28Cs(UInt.m257constructorimpl($this$downTo_u2dKr8caGY & UByte.MAX_VALUE), UInt.m257constructorimpl(to & UByte.MAX_VALUE), -1);
    }
    ...
    public static final UIntProgression m1437downTo5PvTz6A(short $this$downTo_u2d5PvTz6A, short to) {
        return UIntProgression.INSTANCE.m1399fromClosedRangeNkh28Cs(UInt.m257constructorimpl($this$downTo_u2d5PvTz6A & UShort.MAX_VALUE), UInt.m257constructorimpl(65535 & to), -1);
    }
    ...
    public static final UIntRange m1443untilKr8caGY(byte $this$until_u2dKr8caGY, byte to) {
        return Intrinsics.compare(to & UByte.MAX_VALUE, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(UInt.m257constructorimpl($this$until_u2dKr8caGY & UByte.MAX_VALUE), UInt.m257constructorimpl(UInt.m257constructorimpl(to & UByte.MAX_VALUE) - 1), null);
    }

    /* renamed from: until-J1ME1BU, reason: not valid java name */
    public static final UIntRange m1442untilJ1ME1BU(int $this$until_u2dJ1ME1BU, int to) {
        return Integer.compareUnsigned(to, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange($this$until_u2dJ1ME1BU, UInt.m257constructorimpl(to - 1), null);
    }

    /* renamed from: until-eb3DHEI, reason: not valid java name */
    public static final ULongRange m1444untileb3DHEI(long $this$until_u2deb3DHEI, long to) {
        return Long.compareUnsigned(to, 0L) <= 0 ? ULongRange.INSTANCE.getEMPTY() : new ULongRange($this$until_u2deb3DHEI, ULong.m336constructorimpl(to - ULong.m336constructorimpl(1 & 4294967295L)), null);
    }

    /* renamed from: until-5PvTz6A, reason: not valid java name */
    public static final UIntRange m1441until5PvTz6A(short $this$until_u2d5PvTz6A, short to) {
        return Intrinsics.compare(to & UShort.MAX_VALUE, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(UInt.m257constructorimpl($this$until_u2d5PvTz6A & UShort.MAX_VALUE), UInt.m257constructorimpl(UInt.m257constructorimpl(65535 & to) - 1), null);
    }
    ...
    public static final int m1425coerceInWZ9TVnA(int $this$coerceIn_u2dWZ9TVnA, int minimumValue, int maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UInt.m303toStringimpl(maximumValue)) + " is less than minimum " + ((Object) UInt.m303toStringimpl(minimumValue)) + '.');
    }
    ...
    public static final long m1427coerceInsambcqE(long $this$coerceIn_u2dsambcqE, long minimumValue, long maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) ULong.m382toStringimpl(maximumValue)) + " is less than minimum " + ((Object) ULong.m382toStringimpl(minimumValue)) + '.');
    }
    ...
    public static final byte m1426coerceInb33U2AM(byte $this$coerceIn_u2db33U2AM, byte minimumValue, byte maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UByte.m224toStringimpl(maximumValue)) + " is less than minimum " + ((Object) UByte.m224toStringimpl(minimumValue)) + '.');
    }
    ...
    public static final short m1424coerceInVKSA0NQ(short $this$coerceIn_u2dVKSA0NQ, short minimumValue, short maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UShort.m487toStringimpl(maximumValue)) + " is less than minimum " + ((Object) UShort.m487toStringimpl(minimumValue)) + '.');
    }
    ...
    public static final int m1428coerceInwuiCnnA(int $this$coerceIn_u2dwuiCnnA, ClosedRange<UInt> range) {
        ...
        if (range instanceof ClosedFloatingPointRange) {
            return ((UInt) RangesKt.coerceIn(UInt.m251boximpl($this$coerceIn_u2dwuiCnnA), (ClosedFloatingPointRange<UInt>) range)).getData();
        }
        if (range.isEmpty()) {
    ...
    public static final long m1423coerceInJPwROB0(long $this$coerceIn_u2dJPwROB0, ClosedRange<ULong> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((ULong) RangesKt.coerceIn(ULong.m330boximpl($this$coerceIn_u2dJPwROB0), (ClosedFloatingPointRange<ULong>) range)).getData();
        }
        if (range.isEmpty()) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: " + range + '.');
        }
