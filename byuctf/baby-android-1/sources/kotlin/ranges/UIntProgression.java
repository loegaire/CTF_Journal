...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public String toString() {
        ...
        int i;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) UInt.m303toStringimpl(this.first)).append("..").append((Object) UInt.m303toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            append = new StringBuilder().append((Object) UInt.m303toStringimpl(this.first)).append(" downTo ").append((Object) UInt.m303toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
