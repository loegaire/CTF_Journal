...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo1477elapsedNowUwyO8pc() {
            return Duration.m1523minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo1480plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1524plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo1479minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m1493equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1520isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m1590getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m1523minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
        ...
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1493equalsimpl0(mo1479minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1590getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1516hashCodeimpl(Duration.m1524plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1537toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }
