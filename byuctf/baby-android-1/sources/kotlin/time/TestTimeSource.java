...
public final class TestTimeSource extends AbstractLongTimeSource {
    ...
    public final void m1623plusAssignLRDsOJo(long duration) {
        long newReading;
        long longDelta = Duration.m1534toLongimpl(duration, getUnit());
        if (longDelta != Long.MIN_VALUE && longDelta != Long.MAX_VALUE) {
            ...
            double delta = Duration.m1531toDoubleimpl(duration, getUnit());
    ...
    private final void m1622overflowLRDsOJo(long duration) {
        throw new IllegalStateException("TestTimeSource will overflow if its reading " + this.reading + DurationUnitKt.shortName(getUnit()) + " is advanced by " + ((Object) Duration.m1537toStringimpl(duration)) + '.');
    }
}
