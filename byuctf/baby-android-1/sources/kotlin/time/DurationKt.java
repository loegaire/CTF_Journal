...
public final class DurationKt {
    ...
    private static final long m1614timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m1526timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }
    ...
    private static final long m1613timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m1525timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }
    ...
    */
    public static final long parseDuration(String value, boolean strictIso) {
        ...
        long result2 = Duration.INSTANCE.m1590getZEROUwyO8pc();
        ...
        if (value.charAt(index) == 'P') {
            ...
            while (index2 < length3) {
                if (value.charAt(index2) == 'T') {
                    ...
                    if (unit == DurationUnit.SECONDS && dotIndex > 0) {
                        ...
                        String str5 = str3;
                        long result3 = Duration.m1524plusLRDsOJo(result2, toDuration(parseOverLongIsoComponent(whole), unit));
                        Intrinsics.checkNotNull(component, str5);
                        String substring = component.substring(dotIndex);
                        Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String).substring(startIndex)");
                        result2 = Duration.m1524plusLRDsOJo(result3, toDuration(Double.parseDouble(substring), unit));
                        str3 = str5;
                        nonDigitSymbols2 = nonDigitSymbols;
                        length3 = length2;
                        isNegative3 = isNegative2;
                        ...
                        result2 = Duration.m1524plusLRDsOJo(result2, toDuration(parseOverLongIsoComponent(component), unit));
                        str3 = str3;
                        nonDigitSymbols2 = nonDigitSymbols;
                        length3 = length2;
                        isNegative3 = isNegative2;
            ...
            if (!strictIso) {
                if (StringsKt.regionMatches(value, index, "Infinity", 0, Math.max(length3 - index, "Infinity".length()), true)) {
                    result2 = Duration.INSTANCE.m1588getINFINITEUwyO8pc();
                } else {
                    ...
                    while (index < length) {
                        ...
                        if (dotIndex2 > 0) {
                            ...
                            String str6 = str;
                            long result4 = Duration.m1524plusLRDsOJo(result, toDuration(Long.parseLong(whole2), unit2));
                            Intrinsics.checkNotNull(component2, "null cannot be cast to non-null type java.lang.String");
                            String substring2 = component2.substring(dotIndex2);
                            Intrinsics.checkNotNullExpressionValue(substring2, "this as java.lang.String).substring(startIndex)");
                            result = Duration.m1524plusLRDsOJo(result4, toDuration(Double.parseDouble(substring2), unit2));
                            if (index < length) {
                            ...
                            result = Duration.m1524plusLRDsOJo(result, toDuration(Long.parseLong(component2), unit2));
                            str = str;
                            allowSpaces2 = allowSpaces;
                            afterFirst = true;
                        }
        ...
        return isNegative ? Duration.m1540unaryMinusUwyO8pc(result2) : result2;
    }
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m1488constructorimpl(normalNanos << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long normalMillis) {
        return Duration.m1488constructorimpl((normalMillis << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m1488constructorimpl((normalValue << 1) + unitDiscriminator);
    }
