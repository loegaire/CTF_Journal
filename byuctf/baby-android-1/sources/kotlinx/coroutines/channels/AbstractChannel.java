...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final Object mo1667receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
                ...
                switch (abstractChannel$receiveCatching$12.label) {
                    case 0:
                        ...
                        if (result != AbstractChannelKt.POLL_FAILED) {
                            return result instanceof Closed ? ChannelResult.INSTANCE.m1687closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.INSTANCE.m1689successJP2dKIU(result);
                        }
    ...
    public final Object mo1668tryReceivePtdJZtk() {
        Object result = pollInternal();
        return result == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1688failurePtdJZtk() : result instanceof Closed ? ChannelResult.INSTANCE.m1687closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.INSTANCE.m1689successJP2dKIU(result);
    }
    ...
    protected void onCancelIdempotent(boolean wasClosed) {
        ...
        while (true) {
            ...
            if (!(previous instanceof LockFreeLinkedListHead)) {
                ...
                mo1666onCancelIdempotentListww6eGU(list, closed);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int receiveMode, Object value) {
            ...
            switch (receiveMode) {
                ...
                case 1:
                    if (selectInstance.trySelect()) {
                        UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1674boximpl(ChannelResult.INSTANCE.m1687closedJP2dKIU(((Closed) value).closeCause)), selectInstance.getCompletion());
                        return;
                    }
                    return;
                default:
        ...
        if (receiveMode != 1) {
            ...
            Object $this$toResult$iv = ChannelResult.m1674boximpl(value instanceof Closed ? ChannelResult.INSTANCE.m1687closedJP2dKIU(((Closed) value).closeCause) : ChannelResult.INSTANCE.m1689successJP2dKIU(value));
            ...
            while (true) {
                ...
                if (result instanceof Closed) {
                    if (((Closed) result).closeCause == null) {
                        ...
                        cont.resumeWith(Result.m162constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.INSTANCE;
                        cont.resumeWith(Result.m162constructorimpl(ResultKt.createFailure(((Closed) result).getReceiveException())));
                    }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m162constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
            } else {
                ...
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m162constructorimpl(m1674boximpl));
            }
        }
