...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1693debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt__DelayKt.m1695debounceHG0u8IE(flow, timeout);
    }
    ...
    public static final <T> Flow<T> m1694sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt__DelayKt.m1696sampleHG0u8IE(flow, period);
    }
