...
public class ConstraintWidget {
    ...
    */
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        boolean z20 = this.resolvedHorizontal;
        if (z20 || this.resolvedVertical) {
            if (z20) {
        ...
        if (this.mParent == null) {
            ...
            if (!isInVerticalChain && z4 && this.mVisibility != 8 && this.mTop.mTarget == null && this.mBottom.mTarget == null && this.mBaseline == null) {
        ...
        boolean z21 = this.mListDimensionBehaviors[0] != DimensionBehaviour.MATCH_CONSTRAINT;
        boolean z22 = this.mListDimensionBehaviors[1] != DimensionBehaviour.MATCH_CONSTRAINT;
        boolean z23 = false;
        ...
        if (f <= 0.0f || this.mVisibility == 8) {
            ...
            if (this.mListDimensionBehaviors[0] != DimensionBehaviour.MATCH_CONSTRAINT || this.mListDimensionBehaviors[1] != DimensionBehaviour.MATCH_CONSTRAINT || i14 != 3 || i15 != 3) {
                ...
                if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT && i14 == 3) {
                    ...
                    int i17 = (int) (this.mResolvedDimensionRatio * this.mHeight);
                    z7 = z24;
                    if (this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT) {
                        i5 = i17;
                        i3 = i15;
                    ...
                    if (this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT && i15 == 3) {
                        ...
                        int i18 = (int) (this.mResolvedDimensionRatio * this.mWidth);
                        if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT) {
                            i4 = i18;
                            i3 = i15;
                            i2 = i14;
                ...
                boolean z25 = !z8 && ((i11 = this.mResolvedDimensionRatioSide) == 0 || i11 == -1);
                boolean z26 = !z8 && ((i10 = this.mResolvedDimensionRatioSide) == 1 || i10 == -1);
                ...
                if (this.mHorizontalResolution != 2 || this.resolvedHorizontal) {
                    ...
                    if (z && (horizontalWidgetRun = this.horizontalRun) != null && horizontalWidgetRun.start.resolved) {
                        if (!this.horizontalRun.end.resolved) {
                            ...
                            if (this.mParent == null) {
                                ...
                                solverVariable5 = createObjectVariable;
                                z13 = z7;
                            } else if (z2 && this.isTerminalWidget[0] && !isInHorizontalChain()) {
                                linearSystem.addGreaterThan(linearSystem.createObjectVariable(this.mParent.mRight), createObjectVariable2, 0, 8);
                                z11 = z2;
                                z12 = z8;
                                solverVariable = createObjectVariable5;
                    ...
                    solverVariable4 = createObjectVariable2;
                    solverVariable5 = createObjectVariable;
                    applyConstraints(linearSystem, true, z2, z13, z29, createObjectVariable7, createObjectVariable6, dimensionBehaviourArr[0], z9, this.mLeft, this.mRight, this.mX, i6, this.mMinWidth, this.mMaxDimension[0], this.mHorizontalBiasPercent, z25, dimensionBehaviourArr[1] == DimensionBehaviour.MATCH_CONSTRAINT, z5, z6, z27, i2, i3, this.mMatchConstraintMinWidth, this.mMatchConstraintMaxWidth, this.mMatchConstraintPercentWidth, z10);
                }
                boolean z30 = true;
                if (z) {
                    ...
                    if (verticalWidgetRun != null && verticalWidgetRun.start.resolved && constraintWidget3.verticalRun.end.resolved) {
                        ...
                        if (!z14 && !constraintWidget3.resolvedVertical) {
                            boolean z31 = (constraintWidget3.mListDimensionBehaviors[r3] == DimensionBehaviour.WRAP_CONTENT && (constraintWidget3 instanceof ConstraintWidgetContainer)) ? r3 : i8;
                            if (!z31) {
                                i9 = i4;
                            } else {
                                i9 = 0;
                            ...
                            if (constraintWidget3.mBaselineDistance > 0 || constraintWidget3.mVisibility == i7) {
                                if (constraintWidget3.mBaseline.mTarget != null) {
                                    ...
                                    linearSystem2.addEquality(solverVariable6, linearSystem2.createObjectVariable(constraintWidget3.mBaseline.mTarget), constraintWidget3.mBaseline.getMargin(), i7);
                                    if (z13) {
                                        linearSystem2.addGreaterThan(createObjectVariable8, linearSystem2.createObjectVariable(constraintWidget3.mBottom), i8, 5);
                                    }
                                    z15 = false;
                                    boolean z32 = constraintWidget3.isTerminalWidget[r3];
                                    DimensionBehaviour[] dimensionBehaviourArr2 = constraintWidget3.mListDimensionBehaviors;
                                    applyConstraints(linearSystem, false, z13, z11, z32, createObjectVariable9, createObjectVariable8, dimensionBehaviourArr2[r3], z31, constraintWidget3.mTop, constraintWidget3.mBottom, constraintWidget3.mY, i9, constraintWidget3.mMinHeight, constraintWidget3.mMaxDimension[r3], constraintWidget3.mVerticalBiasPercent, z26, dimensionBehaviourArr2[0] != DimensionBehaviour.MATCH_CONSTRAINT, z6, z5, z28, i3, i2, constraintWidget3.mMatchConstraintMinHeight, constraintWidget3.mMatchConstraintMaxHeight, constraintWidget3.mMatchConstraintPercentHeight, z15);
                                } else if (constraintWidget3.mVisibility == i7) {
                                    linearSystem2.addEquality(solverVariable6, solverVariable8, constraintWidget3.mBaseline.getMargin(), i7);
                                } else {
                                    linearSystem2.addEquality(solverVariable6, solverVariable8, getBaselineDistance(), i7);
                                }
                            }
                            z15 = z10;
                            boolean z322 = constraintWidget3.isTerminalWidget[r3];
                            DimensionBehaviour[] dimensionBehaviourArr22 = constraintWidget3.mListDimensionBehaviors;
                            applyConstraints(linearSystem, false, z13, z11, z322, createObjectVariable9, createObjectVariable8, dimensionBehaviourArr22[r3], z31, constraintWidget3.mTop, constraintWidget3.mBottom, constraintWidget3.mY, i9, constraintWidget3.mMinHeight, constraintWidget3.mMaxDimension[r3], constraintWidget3.mVerticalBiasPercent, z26, dimensionBehaviourArr22[0] != DimensionBehaviour.MATCH_CONSTRAINT, z6, z5, z28, i3, i2, constraintWidget3.mMatchConstraintMinHeight, constraintWidget3.mMatchConstraintMaxHeight, constraintWidget3.mMatchConstraintPercentHeight, z15);
                        }
                        if (z12) {
                            if (constraintWidget3.mResolvedDimensionRatioSide == 1) {
                                linearSystem.addRatio(solverVariable7, solverVariable8, solverVariable4, solverVariable5, constraintWidget3.mResolvedDimensionRatio, 8);
                            } else {
                                linearSystem.addRatio(solverVariable4, solverVariable5, solverVariable7, solverVariable8, constraintWidget3.mResolvedDimensionRatio, 8);
                            }
                        }
            ...
            boolean z33 = z4;
            setupDimensionRatio(z2, z33, z21, z22);
            z7 = z33;
        }
        i3 = i15;
        i2 = i14;
    ...
    */
    private void applyConstraints(LinearSystem system, boolean isHorizontal, boolean parentWrapContent, boolean oppositeParentWrapContent, boolean isTerminal, SolverVariable parentMin, SolverVariable parentMax, DimensionBehaviour dimensionBehaviour, boolean wrapContent, ConstraintAnchor beginAnchor, ConstraintAnchor endAnchor, int beginPosition, int dimension, int minDimension, int maxDimension, float bias, boolean useRatio, boolean oppositeVariable, boolean inChain, boolean oppositeInChain, boolean inBarrier, int matchConstraintDefault, int oppositeMatchConstraintDefault, int matchMinDimension, int matchMaxDimension, float matchPercentDimension, boolean applyPosition) {
        ...
        if (numConnections2 < 2 && parentWrapContent && isTerminal3) {
            ...
            int i4 = (isHorizontal || constraintWidget.mBaseline.mTarget == null) ? 1 : i;
            if (!isHorizontal && constraintWidget.mBaseline.mTarget != null) {
                ConstraintWidget target = constraintWidget.mBaseline.mTarget.mOwner;
                i4 = (target.mDimensionRatio != 0.0f && target.mListDimensionBehaviors[i] == DimensionBehaviour.MATCH_CONSTRAINT && target.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT) ? 1 : 0;
            }
            if (i4 != 0) {
