...
public final class UStringsKt {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compareUnsigned(data, UInt.m259constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m176boximpl(UByte.m182constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m259constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m259constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m259constructorimpl(result * uradix);
            result = UInt.m259constructorimpl(UInt.m259constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m253boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m338constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m338constructorimpl(result * uradix);
            result = ULong.m338constructorimpl(ULong.m338constructorimpl(UInt.m259constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m332boximpl(result);
    }
}
