...
public final class DurationKt {
    ...
    private static final long m1616timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m1528timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }
    ...
    private static final long m1615timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m1527timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }
    ...
    */
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m1490constructorimpl(normalNanos << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long normalMillis) {
        return Duration.m1490constructorimpl((normalMillis << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m1490constructorimpl((normalValue << 1) + unitDiscriminator);
    }
