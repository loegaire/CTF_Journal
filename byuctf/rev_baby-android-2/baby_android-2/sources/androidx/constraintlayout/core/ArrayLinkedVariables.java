...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public final void put(SolverVariable variable, float value) {
        ...
        if (availableIndice >= iArr3.length && this.mCurrentSize < iArr3.length) {
            int i3 = 0;
            while (true) {
    ...
    public void add(SolverVariable variable, float value, boolean removeFromDefinition) {
        ...
        int[] iArr4 = this.mArrayIndices;
        if (availableIndice >= iArr4.length && this.mCurrentSize < iArr4.length) {
            int i3 = 0;
            while (true) {
                int[] iArr5 = this.mArrayIndices;
                if (i3 >= iArr5.length) {
