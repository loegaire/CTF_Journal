...
public class WidgetFrame {
    ...
    public static void interpolate(int parentWidth, int parentHeight, WidgetFrame frame, WidgetFrame start, WidgetFrame end, Transition transition, float progress) {
        ...
        if (widgetFrame2.visibility != 8) {
            ...
            startX3 -= (int) (endWidth / 2.0f);
            startY2 -= (int) (endHeight2 / 2.0f);
        ...
        if (widgetFrame.widget != null && transition.hasPositionKeyframes()) {
            ...
            if (firstPosition != null) {
                startX4 = (int) (firstPosition.mX * parentWidth);
                endX = endX2;
                startX2 = parentHeight;
                int startY4 = (int) (firstPosition.mY * startX2);
            ...
            if (lastPosition != null) {
                int endX3 = (int) (lastPosition.mX * parentWidth);
                endY = (int) (lastPosition.mY * startX2);
                endX = endX3;
        ...
        int height = (int) (((1.0f - f) * startHeight2) + (endHeight * f));
