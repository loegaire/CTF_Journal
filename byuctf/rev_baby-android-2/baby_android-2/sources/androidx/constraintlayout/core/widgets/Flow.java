    ...
    private void measureChainWrap(ConstraintWidget[] widgets, int count, int orientation, int max, int[] measured) {
        ...
        if (orientation == 0) {
            ...
            while (i3 < count) {
                ...
                boolean doWrap3 = (width == max || (this.mHorizontalGap + width) + w > max) && list3.mBiggest != null;
            ...
            while (i4 < count) {
                ...
                boolean doWrap4 = (height == max || (this.mVerticalGap + height) + h > max) && list5.mBiggest != null;
    ...
    private void measureChainWrap_new(ConstraintWidget[] widgets, int count, int orientation, int max, int[] measured) {
        ...
        if (orientation == 0) {
            ...
            while (i3 < count) {
                ...
                boolean doWrap3 = (width == max || (this.mHorizontalGap + width) + w > max) && list3.mBiggest != null;
                if (!doWrap3 && i3 > 0 && (i2 = this.mMaxElementsWrap) > 0 && col > i2) {
                    doWrap2 = true;
                } else {
                    doWrap2 = doWrap3;
                }
