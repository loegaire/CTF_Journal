...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    void addVerticalWrapMinVariable(ConstraintAnchor top) {
        ...
        if (weakReference == null || weakReference.get() == null || top.getFinalValue() > this.mVerticalWrapMin.get().getFinalValue()) {
    ...
    public void addHorizontalWrapMinVariable(ConstraintAnchor left) {
        ...
        if (weakReference == null || weakReference.get() == null || left.getFinalValue() > this.mHorizontalWrapMin.get().getFinalValue()) {
    ...
    void addVerticalWrapMaxVariable(ConstraintAnchor bottom) {
        ...
        if (weakReference == null || weakReference.get() == null || bottom.getFinalValue() > this.mVerticalWrapMax.get().getFinalValue()) {
    ...
    public void addHorizontalWrapMaxVariable(ConstraintAnchor right) {
        ...
        if (weakReference == null || weakReference.get() == null || right.getFinalValue() > this.mHorizontalWrapMax.get().getFinalValue()) {
