...
public class ConstraintWidget {
    ...
    /* JADX WARN: Removed duplicated region for block: B:274:0x038b  */
    ...
    */
    ...
    public void updateFromSolver(LinearSystem system, boolean optimize) {
        ...
        if (optimize && (horizontalWidgetRun = this.mHorizontalRun) != null && horizontalWidgetRun.start.resolved && this.mHorizontalRun.end.resolved) {
            left = this.mHorizontalRun.start.value;
            right = this.mHorizontalRun.end.value;
        }
        if (optimize && (verticalWidgetRun = this.mVerticalRun) != null && verticalWidgetRun.start.resolved && this.mVerticalRun.end.resolved) {
