...
public class ArcCurveFit extends CurveFit {
    ...
    private static class Arc {
        ...
        Arc(int mode, double t1, double t2, double x1, double y1, double x2, double y2) {
            ...
            double dy2 = dy;
            double dx4 = dx;
            double hypot = Math.hypot(dy2, dx4);
            this.mArcDistance = hypot;
            this.mArcVelocity = hypot * this.mOneOverDeltaTime;
            double d4 = this.mTime2;
            double d5 = this.mTime1;
            this.mEllipseCenterX = dx4 / (d4 - d5);
            this.mEllipseCenterY = dy2 / (d4 - d5);
        }
        ...
        private void buildTable(double x1, double y1, double x2, double y2) {
            ...
            while (true) {
                if (i3 < this.mLut.length) {
                    ...
                    if (index >= 0) {
                        this.mLut[i3] = index / (sOurPercent.length - 1);
                    } else if (index == -1) {
                        this.mLut[i3] = 0.0d;
                    } else {
                        int p1 = (-index) - 2;
