...
public class MotionController {
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (!points[j].mAttributes.containsKey(attributeName) || (attribute = points[j].mAttributes.get(attributeName)) == null) {
                    j++;
    ...
    /* JADX WARN: Incorrect condition in loop: B:21:0x007d */
    /*
