...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1692invokeWpGqRn0(((ChannelResult) obj).getHolder(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0, reason: not valid java name */
    public final Object m1692invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1676boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.label) {
            case 0:
                ...
                Throwable m1680exceptionOrNullimpl = ChannelResult.m1680exceptionOrNullimpl(holder);
                if (m1680exceptionOrNullimpl != null) {
                    throw m1680exceptionOrNullimpl;
                }
                Function2<E, Continuation<? super R>, Object> function2 = this.$block;
                Object m1681getOrNullimpl = ChannelResult.m1681getOrNullimpl(holder);
                this.label = 1;
                Object invoke = function2.invoke(m1681getOrNullimpl, this);
