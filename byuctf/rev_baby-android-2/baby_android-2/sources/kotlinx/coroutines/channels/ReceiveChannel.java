...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1670tryReceivePtdJZtk = receiveChannel.mo1670tryReceivePtdJZtk();
            if (ChannelResult.m1686isSuccessimpl(mo1670tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1682getOrThrowimpl(mo1670tryReceivePtdJZtk);
            }
            Throwable m1680exceptionOrNullimpl = ChannelResult.m1680exceptionOrNullimpl(mo1670tryReceivePtdJZtk);
            if (m1680exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1680exceptionOrNullimpl);
        }
