...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Object mo1671trySendJP2dKIU(E element) {
        ...
        if (result == AbstractChannelKt.OFFER_FAILED) {
            ...
            return closedForSend == null ? ChannelResult.INSTANCE.m1690failurePtdJZtk() : ChannelResult.INSTANCE.m1689closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (result instanceof Closed) {
            return ChannelResult.INSTANCE.m1689closedJP2dKIU(helpCloseAndGetSendException((Closed) result));
        }
    ...
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (offerResult == AbstractChannelKt.OFFER_SUCCESS) {
                ...
                cont.resumeWith(Result.m164constructorimpl(Unit.INSTANCE));
                break;
            }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (it = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            Result.Companion companion = Result.INSTANCE;
            continuation.resumeWith(Result.m164constructorimpl(ResultKt.createFailure(it)));
        } else {
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m164constructorimpl(ResultKt.createFailure(sendException)));
        }
    }
    ...
    */
    ...
    private final void helpClose(Closed<?> closed) {
        Object closedList = InlineList.m1707constructorimpl$default(null, 1, null);
        while (true) {
            LockFreeLinkedListNode prevNode = closed.getPrevNode();
            Receive previous = prevNode instanceof Receive ? (Receive) prevNode : null;
            if (previous == null) {
                break;
            } else if (!previous.mo1715remove()) {
                previous.helpRemove();
            } else {
                closedList = InlineList.m1712plusFjFbRPM(closedList, previous);
            }
        }
        if (closedList != null) {
