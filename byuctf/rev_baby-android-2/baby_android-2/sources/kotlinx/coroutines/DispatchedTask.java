            ...
            try {
                ...
                try {
                    if (job != null && !job.isActive()) {
                        ...
                        continuation.resumeWith(Result.m164constructorimpl(ResultKt.createFailure(exception)));
                    } else {
                        Result.Companion companion3 = Result.INSTANCE;
                        continuation.resumeWith(Result.m164constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(state)));
                    }
                    ...
                    try {
                        ...
                        result = Result.m164constructorimpl(Unit.INSTANCE);
                    } catch (Throwable th3) {
                        th = th3;
                        Result.Companion companion5 = Result.INSTANCE;
                        result = Result.m164constructorimpl(ResultKt.createFailure(th));
                        handleFatalException(fatalException, Result.m167exceptionOrNullimpl(result));
                    }
                } catch (Throwable th4) {
                    th = th4;
                }
