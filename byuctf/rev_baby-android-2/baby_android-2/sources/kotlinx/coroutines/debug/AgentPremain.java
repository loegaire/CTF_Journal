...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m164constructorimpl = Result.m164constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m164constructorimpl = Result.m164constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m170isFailureimpl(m164constructorimpl) ? null : m164constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1693installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1693installSignalHandler$lambda1(Signal it) {
