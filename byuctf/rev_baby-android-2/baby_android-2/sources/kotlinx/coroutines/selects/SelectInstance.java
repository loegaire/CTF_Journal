...
public final class SelectInstance<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, kotlinx.coroutines.selects.SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
                ...
                if (result$iv == update$iv2) {
                    ...
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, coroutine_suspended, obj3)) {
                        if (Result.m170isFailureimpl(result)) {
                            ...
                            Throwable exception$iv = Result.m167exceptionOrNullimpl(result);
                            ...
                            $this$resumeWithStackTrace$iv.resumeWith(Result.m164constructorimpl(ResultKt.createFailure(th)));
                            return;
                        }
            ...
            if (result$iv == obj) {
                ...
                if (result$iv == update$iv2) {
                    ...
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, coroutine_suspended, obj3)) {
                        ...
                        Result.Companion companion = Result.INSTANCE;
                        intercepted.resumeWith(Result.m164constructorimpl(ResultKt.createFailure(exception)));
                        return;
                    }
                } else {
                    throw new IllegalStateException("Already resumed");
    ...
    public final void handleBuilderException(Throwable e) {
        if (trySelect()) {
            Result.Companion companion = Result.INSTANCE;
            resumeWith(Result.m164constructorimpl(ResultKt.createFailure(e)));
