...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m164constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            obj = Result.m164constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m167exceptionOrNullimpl(obj) == null) {
            obj4 = obj;
        }
        baseContinuationImplClassName = (String) obj4;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            obj2 = Result.m164constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            obj2 = Result.m164constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m167exceptionOrNullimpl(obj2) == null) {
            obj3 = obj2;
        }
