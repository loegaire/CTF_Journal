...
/* DWARF original prototype: void reflect.(*ChanDir).String(string ~r0) */

string reflect___ChanDir__String(void)
  ...
  do {
    ...
    if (*(undefined1 **)(lVar1 + 0x10) < register0x00000020) {
      ...
      *(undefined1 **)((long)register0x00000020 + -8) = unaff_RBP;
      ...
      if (*(reflect_ChanDir **)((long)register0x00000020 + 8) != (reflect_ChanDir *)0x0) {
        d = **(reflect_ChanDir **)((long)register0x00000020 + 8);
        *(reflect_ChanDir *)((long)register0x00000020 + -0x20) = d;
        *(undefined8 *)((long)register0x00000020 + -0x28) = 0x53e49c;
        sVar4 = reflect_ChanDir_String(d);
      ...
      *(undefined8 *)((long)register0x00000020 + -0x28) = 0x53e4bf;
      runtime_panicwrap();
    }
    *(undefined8 *)(puVar3 + -8) = 0x53e4c5;
