...
/* DWARF original prototype: void syscall.getdirentries_freebsd12(int fd, []uint8 buf, uint64 *
   basep, int n, error err) */

multireturn_int_error_ syscall_getdirentries_freebsd12(int fd,__uint8 buf,uint64 *basep)

{
  ...
  if (local_28 == 0) {
    ...
    if (local_28 < 3) {
      ...
      if (local_28 == 2) goto LAB_00548bc6;
    }
    else {
