...
/* WARNING: Removing unreachable block (ram,0x005a20fe) */
/* WARNING: Unknown calling convention */
/* DWARF original prototype: void net.(*UDPAddr).String(net.UDPAddr * a, string ~r0) */

string net___UDPAddr__String(net_UDPAddr *a)

{
  ...
  if ((a_spill->Zone).len == 0) {
    ...
    if (local_a8 < 0) {
      ...
      a2_02.len = in_R9;
      a2_02.str = in_R8;
      sVar5 = runtime_concatstring3(local_b0,a0_02,a1_01,a2_02);
      iVar3 = sVar5.len;
      local_78 = local_88;
    }
    else {
      ...
      a3_00.len = in_R11;
      a3_00.str = in_R10;
      sVar5 = runtime_concatstring4(local_b0,a0_01,a1_00,a2_01,a3_00);
      iVar3 = sVar5.len;
    }
    sVar7.len = iVar3;
    sVar7.str = local_78;
  ...
  a2.len = in_R9;
  a2.str = in_R8;
  sVar5 = runtime_concatstring3((runtime_tmpBuf *)(a_spill->Zone).len,a0,sVar5,a2);
  ...
  a3.len = in_R11;
  a3.str = in_R10;
  sVar5 = runtime_concatstring4(local_b0,a0_00,a1,a2_00,a3);
  sVar6.len = sVar5.len;
  sVar6.str = local_78;
  return sVar6;
}
