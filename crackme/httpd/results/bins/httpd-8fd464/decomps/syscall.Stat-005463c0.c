...
/* DWARF original prototype: void syscall.Stat(string path, syscall.Stat_t * st, error err) */

error syscall_Stat(string path,syscall_Stat_t *st)

{
  ...
  if (local_190 == '\0') {
    ...
    eVar1 = syscall_stat(path_00,(syscall_stat_freebsd11_t *)st);
