...
/* DWARF original prototype: void net.(*UDPAddr).sockaddr(net.UDPAddr * a, int family,
   syscall.Sockaddr ~r1, error ~r2) */

multireturn_syscall_Sockaddr_error_ net___UDPAddr__sockaddr(net_UDPAddr *a,int family)
