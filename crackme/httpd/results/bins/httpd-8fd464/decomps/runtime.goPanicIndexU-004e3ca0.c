...

{
  ...
  do {
    if (*(undefined1 **)(*(long *)(in_FS_OFFSET + -8) + 0x10) < register0x00000020) {
      ...
      *(undefined8 *)((long)register0x00000020 + -0x48) = 0x4e3ce5;
      msg.len = in_RCX;
      msg.str = e.data;
      ...
      *(undefined8 *)((long)register0x00000020 + -0x48) = 0x4e3d2e;
