...
/* DWARF original prototype: void net.sockaddrToTCP(syscall.Sockaddr sa, net.Addr ~r1) */

net_Addr net_sockaddrToTCP(syscall_Sockaddr sa)
  ...
  if (in_stack_00000008 != (runtime_itab *)0x0) {
    ...
    if (uVar1 == 0x61a1523f) {
      if (in_stack_00000008 == (runtime_itab *)go_itab__syscall_SockaddrInet4_syscall_Sockaddr) {
        ...
        nVar4.tab = (runtime_itab *)go_itab__net_TCPAddr_net_Addr;
        return nVar4;
      }
    }
    else {
      ...
      if ((uVar1 == 0x98d3a9ba) &&
        ...
        nVar6.tab = (runtime_itab *)go_itab__net_TCPAddr_net_Addr;
        return nVar6;
      }
    }
  }
