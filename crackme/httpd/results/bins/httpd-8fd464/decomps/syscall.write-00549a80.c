...
/* DWARF original prototype: void syscall.write(int fd, []uint8 p, int n, error err) */

multireturn_int_error_ syscall_write(int fd,__uint8 p)

{
  ...
  if (local_20 == 0) {
    ...
    if (local_20 < 3) {
      ...
      if (local_20 == 2) goto LAB_00549b5c;
    }
    else {
