...
/* DWARF original prototype: void net.(*addrinfoErrno).Error(string ~r0) */

string net___addrinfoErrno__Error(void)

{
  long lVar1;
  long *plVar2;
  net_addrinfoErrno eai;
  undefined1 *puVar3;
  ...
  do {
    ...
    if (*(undefined1 **)(lVar1 + 0x10) < register0x00000020) {
      ...
      *(undefined1 **)((long)register0x00000020 + -8) = unaff_RBP;
      ...
      if (*(net_addrinfoErrno **)((long)register0x00000020 + 8) != (net_addrinfoErrno *)0x0) {
        eai = **(net_addrinfoErrno **)((long)register0x00000020 + 8);
        *(net_addrinfoErrno *)((long)register0x00000020 + -0x20) = eai;
        *(undefined8 *)((long)register0x00000020 + -0x28) = 0x5a8f3c;
        sVar4 = net_addrinfoErrno_Error(eai);
      ...
      *(undefined8 *)((long)register0x00000020 + -0x28) = 0x5a8f5f;
      runtime_panicwrap();
    }
    *(undefined8 *)(puVar3 + -8) = 0x5a8f65;
