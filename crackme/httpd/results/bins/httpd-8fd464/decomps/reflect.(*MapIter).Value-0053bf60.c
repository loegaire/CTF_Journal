...
/* DWARF original prototype: void reflect.(*MapIter).Value(reflect.MapIter * it, reflect.Value ~r0)
    */

reflect_Value reflect___MapIter__Value(reflect_MapIter *it)

{
  ...
  do {
                    /* Unresolved local var: reflect.mapType * t@[???]
                       Unresolved local var: reflect.rtype * vtype@[???] */
    ...
    if (*(undefined1 **)(*(long *)(in_FS_OFFSET + -8) + 0x10) < register0x00000020) {
      ...
      *(undefined1 **)((long)register0x00000020 + -8) = unaff_RBP;
      ...
      if (prVar2 != (runtime_hmap *)0x0) {
        ...
        *(undefined8 *)((long)register0x00000020 + -0x58) = 0x53bf9c;
        ...
        if (*(long *)((long)register0x00000020 + -0x48) != 0) {
          ...
          *(undefined8 *)((long)register0x00000020 + -0x58) = 0x53bfd7;
          reflect_mapiterelem(it_00);
          ...
          *(undefined8 *)((long)register0x00000020 + -0x58) = 0x53c019;
        ...
        *(undefined1 **)((long)register0x00000020 + -0x48) = reflect__stmp_91;
        *(undefined8 *)((long)register0x00000020 + -0x58) = 0x53c05d;
        e.data = unaff_RBX;
        e._type = (runtime__type *)reflect__stmp_91;
        runtime_gopanic(e);
      }
      *(undefined **)((long)register0x00000020 + -0x50) = &DAT_00225520;
      *(undefined1 **)((long)register0x00000020 + -0x48) = reflect__stmp_90;
      *(undefined8 *)((long)register0x00000020 + -0x58) = 0x53c079;
      e_00.data = unaff_RBX;
      e_00._type = (runtime__type *)reflect__stmp_90;
      runtime_gopanic(e_00);
    }
    *(undefined8 *)(puVar6 + -8) = 0x53c07f;
