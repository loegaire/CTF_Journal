...
/* DWARF original prototype: void fmt.Fprint(io.Writer w, []interface_{} a, int n, error err) */

multireturn_int_error_ fmt_Fprint(io_Writer w,__interface___ a)

{
  ...
  a_00.cap = iVar1;
  fmt___pp__doPrint(local_60,a_00);
