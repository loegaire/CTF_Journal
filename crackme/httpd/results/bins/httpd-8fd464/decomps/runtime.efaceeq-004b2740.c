...
/* DWARF original prototype: void runtime.efaceeq(runtime._type * t, void * x, void * y, bool ~r3)
    */

bool runtime_efaceeq(runtime__type *t,void *x,void *y)
  ...
  do {
    ...
    if (*(undefined1 **)(*(long *)(in_FS_OFFSET + -8) + 0x10) < register0x00000020) {
      ...
      *(undefined1 **)((long)register0x00000020 + -8) = unaff_RBP;
      ...
      t_00 = *(runtime__type **)((long)register0x00000020 + 8);
      ...
      if (ppfVar1 != (func_unsafe_Pointer__unsafe_Pointer__bool **)0x0) {
        ...
        *(undefined8 *)((long)register0x00000020 + -0x48) = 0x4b27b0;
      ...
      *(runtime__type **)((long)register0x00000020 + -0x40) = t_00;
      *(undefined8 *)((long)register0x00000020 + -0x48) = 0x4b27db;
      sVar5 = runtime____type__string(t_00);
      ...
      *(undefined8 *)((long)register0x00000020 + -0x48) = 0x4b2811;
      a0.len = iVar3;
      a1.len = (int)in_RSI;
      a1.str = in_RDI;
      ...
      *(undefined8 *)((long)register0x00000020 + -0x38) =
           *(undefined8 *)((long)register0x00000020 + -0x10);
      *(undefined8 *)((long)register0x00000020 + -0x48) = 0x4b2829;
      ...
      *(undefined8 *)((long)register0x00000020 + -0x48) = 0x4b2845;
      e.data = sVar5.len;
      e._type = *(runtime__type **)((long)register0x00000020 + -0x30);
      runtime_gopanic(e);
    }
    *(undefined8 *)(puVar4 + -8) = 0x4b284b;
