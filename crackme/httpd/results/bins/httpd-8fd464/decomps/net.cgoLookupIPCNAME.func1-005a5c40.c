...
/* DWARF original prototype: void net.cgoLookupIPCNAME.func1([]uint8 h, net._Ctype_struct_addrinfo *
   &hints, net._Ctype_struct_addrinfo * * &res, net._Ctype_int ~r0, error ~r1) */

multireturn_net__Ctype_int_error__conflict
net_cgoLookupIPCNAME_func1
          (__uint8 h,net__Ctype_struct_addrinfo *_hints,net__Ctype_struct_addrinfo **_res)

{
  ...
  __uint8 h_spill;
  net__Ctype_struct_addrinfo *_cgoBase2;
  net__Ctype_struct_addrinfo **_cgoBase3;
  undefined4 local_20;
  void *local_18;
  
  ptr.data = (net__Ctype_char *)h.len;
  while (&stack0x00000000 <= *(undefined1 **)(*(long *)(in_FS_OFFSET + -8) + 0x10)) {
    runtime_morestack_noctxt();
  }
  if (h_spill.len != 0) {
    ptr._type = (runtime__type *)_cgoBase2;
    arg.data = _hints;
    arg._type = (runtime__type *)&DAT_00222aa0;
    ...
    mVar1 = net__C2func_getaddrinfo
                      ((net__Ctype_char *)_cgoBase3,ptr.data,p2,
