...
/* DWARF original prototype: void net.(*TCPListener).SetDeadline(net.TCPListener * l, time.Time t,
   error ~r1) */

error net___TCPListener__SetDeadline(net_TCPListener *l,time_Time t)
