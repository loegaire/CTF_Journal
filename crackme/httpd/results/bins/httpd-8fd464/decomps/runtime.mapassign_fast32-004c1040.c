...
/* DWARF original prototype: void runtime.mapassign_fast32(runtime.maptype * t, runtime.hmap * h,
   uint32 key, void * ~r3) */

void * runtime_mapassign_fast32(runtime_maptype *t,runtime_hmap *h,uint32 key)

{
  runtime_mapextra **pprVar1;
  code *pcVar2;
  undefined8 *puVar3;
  byte bVar4;
  ...
  do {
    ...
    if (*(undefined1 **)(*(long *)(in_FS_OFFSET + -8) + 0x10) < register0x00000020) {
      ...
      *(undefined8 *)((long)register0x00000020 + -0x40) = 0x4c137a;
      e.data = h;
      e._type = (runtime__type *)runtime__stmp_76;
      runtime_gopanic(e);
    }
    *(undefined8 *)(puVar12 + -8) = 0x4c1385;
  ...
  if ((*(byte *)(lVar9 + 8) & 4) != 0) {
    ...
    *(undefined8 *)((long)register0x00000020 + -0x40) = 0x4c135e;
    s_00.len = (int)h;
  ...
  *(undefined8 *)((long)register0x00000020 + -0x40) = 0x4c109b;
  (*pcVar2)();
  ...
  *(char *)(plVar7 + 1) = (char)(bVar4 ^ 4);
  if (plVar7[2] == 0) {
    ...
    *(undefined8 *)((long)register0x00000020 + -0x40) = 0x4c10da;
    ...
    if (runtime_writeBarrier._0_4_ == 0) {
      ...
      *(undefined8 *)((long)register0x00000020 + -0x40) = 0x4c1105;
  ...
  do {
    ...
    if (plVar7[3] != 0) {
      ...
      *(undefined8 *)((long)register0x00000020 + -0x40) = 0x4c1173;
      runtime_growWork_fast32(t_00,prVar10,(ulong)bVar4);
    ...
    do {
      ...
      for (uVar8 = 0; prVar11 = b, uVar8 < 8; uVar8 = uVar8 + 1) {
        if (*(uint8 *)((long)&prVar5->count + uVar8) < 2) {
          ...
          uVar13 = uVar14;
          if (*(uint8 *)((long)&prVar5->count + uVar8) == 0) goto LAB_004c11a3;
        }
        else {
          prVar10 = (runtime_hmap *)(ulong)*(uint *)(&prVar5->flags + uVar8 * 4);
          if (*(uint *)((long)register0x00000020 + 0x18) == *(uint *)(&prVar5->flags + uVar8 * 4))
          goto LAB_004c12fe;
        }
        b = prVar11;
                    /* Unresolved local var: uint32 k@[???] */
      }
      prVar10 = *(runtime_hmap **)((long)prVar5 + ((ulong)*(ushort *)(lVar9 + 0x52) - 8));
    } while (prVar10 != (runtime_hmap *)0x0);
LAB_004c11a3:
    if (plVar7[3] != 0) goto LAB_004c12a0;
    bVar4 = *(byte *)((long)plVar7 + 9);
    uVar6 = (uint)bVar4;
...
LAB_004c12a0:
        ...
        if (prVar11 == (runtime_hmap *)0x0) {
          ...
          *(undefined8 *)((long)register0x00000020 + -0x40) = 0x4c12b8;
        ...
        *(undefined4 *)(&prVar5->flags + uVar8 * 4) =
             *(undefined4 *)((long)register0x00000020 + 0x18);
        *plVar7 = *plVar7 + 1;
        prVar10 = prVar5;
LAB_004c12fe:
        pprVar1 = (runtime_mapextra **)((long)&prVar5->extra + uVar8 * *(byte *)(lVar9 + 0x51));
        if ((*(byte *)(plVar7 + 1) & 4) != 0) {
          *(byte *)(plVar7 + 1) = *(byte *)(plVar7 + 1) & 0xfb;
          *(runtime_mapextra ***)((long)register0x00000020 + 0x20) = pprVar1;
          return pprVar1;
        }
        *(undefined **)((long)register0x00000020 + -0x38) = &DAT_0029c838;
        *(undefined8 *)((long)register0x00000020 + -0x30) = 0x15;
                    /* WARNING: Subroutine does not return */
        *(undefined8 *)((long)register0x00000020 + -0x40) = 0x4c1345;
        s.len = (int)prVar10;
        s.str = &DAT_0029c838;
        runtime_throw(s);
      }
    ...
    *(long *)((long)register0x00000020 + -0x38) = lVar9;
    *(long **)((long)register0x00000020 + -0x30) = plVar7;
    *(undefined8 *)((long)register0x00000020 + -0x40) = 0x4c1125;
