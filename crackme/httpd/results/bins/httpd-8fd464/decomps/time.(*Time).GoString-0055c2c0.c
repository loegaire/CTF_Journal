...
/* DWARF original prototype: void time.(*Time).GoString(string ~r0) */

string time___Time__GoString(void)
    ...
    if (*(undefined1 **)(lVar1 + 0x10) < register0x00000020) {
      ...
      *(undefined1 **)((long)register0x00000020 + -8) = unaff_RBP;
      ...
      if (puVar3 != (undefined8 *)0x0) {
        ...
        *(undefined8 *)((long)register0x00000020 + -0x38) = 0x55c30e;
        t.ext = unaff_RBX;
        t.wall = uVar6;
        t.loc = ptVar4;
        sVar8 = time_Time_GoString(t);
      ...
      *(undefined8 *)((long)register0x00000020 + -0x38) = 0x55c331;
      runtime_panicwrap();
    }
    *(undefined8 *)(puVar7 + -8) = 0x55c337;
