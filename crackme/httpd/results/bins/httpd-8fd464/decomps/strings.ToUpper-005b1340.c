...
/* DWARF original prototype: void strings.ToUpper(string s, string ~r1) */

string strings_ToUpper(string s)
...
code_r0x005b1340:
                    /* Unresolved local var: bool isASCII@[???]
                       Unresolved local var: bool hasLower@[???] */
  ...
  if (*(undefined1 **)(*(long *)(in_FS_OFFSET + -8) + 0x10) <
    ...
    *(undefined1 **)((long)register0x00000020 + -8) = unaff_RBP;
    ...
    for (lVar4 = 0; lVar4 < (long)et; lVar4 = lVar4 + 1) {
      ...
      if (0x7f < bVar1) {
        *(undefined ***)((long)register0x00000020 + -0x90) = &PTR_unicode_ToUpper_002b3b78;
        *(long *)((long)register0x00000020 + -0x88) = lVar3;
        *(runtime__type **)((long)register0x00000020 + -0x80) = et;
        *(undefined8 *)((long)register0x00000020 + -0x98) = 0x5b13cf;
        s_00.len = lVar3;
        s_00.str = puVar5;
    ...
    *(undefined1 **)((long)register0x00000020 + -0x28) =
    ...
    if (*(long *)((long)register0x00000020 + -0x10) - lVar4 < (long)et) {
      ...
      *(undefined8 *)((long)register0x00000020 + -0x98) = 0x5b1472;
      ...
      if (*(long *)((long)register0x00000020 + -0x20) != lVar2) {
        ...
        *(undefined8 *)((long)register0x00000020 + -0x98) = 0x5b14ad;
        runtime_memmove();
    ...
    do {
      ...
      if (*(undefined1 **)((long)register0x00000020 + -0x28) == (undefined1 *)0x0) {
        *(undefined1 **)((long)register0x00000020 + -0x28) =
             (undefined1 *)((long)register0x00000020 + -0x28);
               ...
               (undefined1 *)((long)register0x00000020 + -0x28)) goto LAB_005b1607;
      lVar4 = *(long *)((long)register0x00000020 + -0x18);
      ...
      if (*(ulong *)((long)register0x00000020 + -0x10) < lVar4 + 1U) {
        ...
        *(undefined8 *)((long)register0x00000020 + -0x98) = 0x5b159d;
        old.len = lVar3;
        old.array = pvVar6;
        old.cap = lVar4;
...
LAB_005b1607:
  ...
  *(undefined8 *)((long)register0x00000020 + -0x98) = 0x5b1625;
  e.data = pvVar6;
  e._type = (runtime__type *)&net_http__stmp_78;
  runtime_gopanic(e);
LAB_005b1626:
  *(undefined8 *)(puVar7 + -8) = 0x5b162b;
  runtime_morestack_noctxt();
  register0x00000020 = (BADSPACEBASE *)puVar7;
  goto code_r0x005b1340;
}
