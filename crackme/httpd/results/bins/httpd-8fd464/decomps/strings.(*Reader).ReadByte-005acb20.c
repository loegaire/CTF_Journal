...
/* DWARF original prototype: void strings.(*Reader).ReadByte(strings.Reader * r, uint8 ~r0, error
   ~r1) */

multireturn_uint8_error_ strings___Reader__ReadByte(strings_Reader *r)
