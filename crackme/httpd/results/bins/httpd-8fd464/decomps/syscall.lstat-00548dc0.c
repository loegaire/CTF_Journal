...
/* DWARF original prototype: void syscall.lstat(string path, syscall.stat_freebsd11_t * stat, error
   err) */

error syscall_lstat(string path,syscall_stat_freebsd11_t *stat)
...
LAB_00548e56:
  ...
  if (local_38 == 0) {
    ...
    if (local_38 < 3) {
      ...
      if (local_38 == 2) goto LAB_00548f2d;
    }
    else {
