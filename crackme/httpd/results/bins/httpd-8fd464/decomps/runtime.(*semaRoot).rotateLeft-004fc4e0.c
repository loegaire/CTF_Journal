...

{
  ...
  prVar2 = x_spill->next;
  prVar3 = x_spill->parent;
  prVar1 = prVar2->prev;
  if (runtime_writeBarrier._0_4_ == 0) {
    prVar2->prev = x_spill;
    x_spill->parent = prVar2;
    x_spill->next = prVar1;
  }
  else {
    ...
    x_spill = extraout_RAX;
    prVar3 = extraout_RDX;
  }
  if (prVar1 != (runtime_sudog *)0x0) {
    if (runtime_writeBarrier._0_4_ == 0) {
      prVar1->parent = x_spill;
    }
    else {
      runtime_gcWriteBarrier();
      x_spill = extraout_RAX_00;
