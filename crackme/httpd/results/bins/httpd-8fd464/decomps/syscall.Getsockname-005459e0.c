...
/* DWARF original prototype: void syscall.Getsockname(int fd, syscall.Sockaddr sa, error err) */

multireturn_syscall_Sockaddr_error__conflict syscall_Getsockname(int fd)

{
  ...
  local_78 = 0x6c;
  eVar2 = syscall_getsockname((int)mVar5.sa.tab,unaff_RBX,&local_78);
