...

{
  ...
  do {
    if (*(undefined1 **)(*(long *)(in_FS_OFFSET + -8) + 0x10) < register0x00000020) {
      ...
      *(undefined **)((long)register0x00000020 + -0x38) = &DAT_0029abba;
      *(undefined8 *)((long)register0x00000020 + -0x30) = 0x12;
      *(undefined8 *)((long)register0x00000020 + -0x48) = 0x4e3c25;
      msg.len = in_RCX;
      msg.str = e.data;
      runtime_panicCheck1(0x29abba,msg);
      ...
      *(undefined1 *)((long)register0x00000020 + -0x10) = 1;
      *(undefined8 *)((long)register0x00000020 + -0x18) =
           *(undefined8 *)((long)register0x00000020 + 0x10);
      *(undefined1 *)((long)register0x00000020 + -0xf) = 0;
      ...
      *(undefined8 *)((long)register0x00000020 + -0x48) = 0x4e3c6e;
