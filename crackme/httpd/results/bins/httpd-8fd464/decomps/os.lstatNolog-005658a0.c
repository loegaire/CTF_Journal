...
/* DWARF original prototype: void os.lstatNolog(string name, io/fs.FileInfo ~r1, error ~r2) */

multireturn_io_fs_FileInfo_error_ os_lstatNolog(string name)

{
  ...
  do {
    ...
    syscall_Lstat(path,(syscall_Stat_t *)name_spill.str);
  ...
  *(undefined8 *)(name_spill.len + 8) = 5;
  *(undefined **)name_spill.len = &DAT_00288edf;
