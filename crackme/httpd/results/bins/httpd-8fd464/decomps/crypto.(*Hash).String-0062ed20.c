...
/* DWARF original prototype: void crypto.(*Hash).String(string ~r0) */

string crypto___Hash__String(void)
  ...
  do {
    ...
    if (*(undefined1 **)(lVar1 + 0x10) < register0x00000020) {
      ...
      *(undefined1 **)((long)register0x00000020 + -8) = unaff_RBP;
      ...
      if (*(crypto_Hash **)((long)register0x00000020 + 8) != (crypto_Hash *)0x0) {
        h = **(crypto_Hash **)((long)register0x00000020 + 8);
        *(crypto_Hash *)((long)register0x00000020 + -0x20) = h;
        *(undefined8 *)((long)register0x00000020 + -0x28) = 0x62ed5c;
        sVar4 = crypto_Hash_String(h);
      ...
      *(undefined8 *)((long)register0x00000020 + -0x28) = 0x62ed7f;
      runtime_panicwrap();
    }
    *(undefined8 *)(puVar3 + -8) = 0x62ed85;
