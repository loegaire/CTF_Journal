...
/* DWARF original prototype: void net.sockaddrToUnixpacket(syscall.Sockaddr sa, net.Addr ~r1) */

net_Addr net_sockaddrToUnixpacket(syscall_Sockaddr sa)
