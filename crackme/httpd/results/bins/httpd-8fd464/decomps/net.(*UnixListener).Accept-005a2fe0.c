...
/* DWARF original prototype: void net.(*UnixListener).Accept(net.UnixListener * l, net.Conn ~r0,
   error ~r1) */

multireturn_net_Conn_error__conflict net___UnixListener__Accept(net_UnixListener *l)

{
  ...
  if ((l_spill != (net_UnixListener *)0x0) && (l_spill->fd != (net_netFD *)0x0)) {
    ...
    mVar5.~r1.tab = (runtime_itab *)go_itab__net_UnixConn_net_Conn;
    return mVar5;
  }
