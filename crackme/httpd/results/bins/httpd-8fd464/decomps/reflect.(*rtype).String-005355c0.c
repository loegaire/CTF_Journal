...
/* DWARF original prototype: void reflect.(*rtype).String(reflect.rtype * t, string ~r0) */

string reflect___rtype__String(reflect_rtype *t)

{
  reflect_nameOff rVar1;
  int32 unaff_EBX;
  long in_FS_OFFSET;
  string sVar2;
  string sVar3;
  ...
  rVar1 = t_spill->str;
  reflect_resolveNameOff(t_spill,unaff_EBX);
  sVar2 = reflect_name_name(local_10);
