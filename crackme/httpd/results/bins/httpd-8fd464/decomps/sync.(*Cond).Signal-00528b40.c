    ...
    if (*(undefined1 **)(*(long *)(in_FS_OFFSET + -8) + 0x10) < register0x00000020) {
      ...
      *(undefined1 **)((long)register0x00000020 + -8) = unaff_RBP;
      ...
      if (((char)pvVar3 == '\0') || (*(long *)(lVar2 + 0x30) == lVar1)) {
        ...
        *(undefined8 *)((long)register0x00000020 + -0x20) = 0x528b9e;
        sync_runtime_notifyListNotifyOne((runtime_notifyList *)(lVar2 + 0x10));
        return;
      }
      *(undefined **)((long)register0x00000020 + -0x18) = &DAT_00225520;
      *(undefined1 **)((long)register0x00000020 + -0x10) = sync__stmp_0;
      *(undefined8 *)((long)register0x00000020 + -0x20) = 0x528bc5;
      e.data = pvVar3;
      e._type = (runtime__type *)sync__stmp_0;
      runtime_gopanic(e);
    }
    *(undefined8 *)(puVar4 + -8) = 0x528bcb;
