...
/* DWARF original prototype: void runtime.(*errorAddressString).Error(string ~r0) */

string runtime___errorAddressString__Error(void)
    ...
    if (*(undefined1 **)(lVar1 + 0x10) < register0x00000020) {
      ...
      *(undefined1 **)((long)register0x00000020 + -8) = unaff_RBP;
      ...
      if (piVar3 != (int *)0x0) {
        ...
        *(undefined8 *)((long)register0x00000020 + -0x48) = 0x51c685;
        sVar6.len = in_RSI;
        sVar6.str = in_RDI;
        a0.len = iVar4;
        a0.str = unaff_RBX;
      ...
      *(undefined8 *)((long)register0x00000020 + -0x48) = 0x51c6a8;
      runtime_panicwrap();
    }
    *(undefined8 *)(puVar5 + -8) = 0x51c6ae;
