...
/* DWARF original prototype: void net.(*TCPListener).Close(net.TCPListener * l, error ~r0) */

error net___TCPListener__Close(net_TCPListener *l)

{
  ...
  if ((l_spill != (net_TCPListener *)0x0) && (l_spill->fd != (net_netFD *)0x0)) {
    eVar4 = net___netFD__Close((net_netFD *)l_spill);
