...
/* DWARF original prototype: void syscall.bind(int s, void * addr, syscall._Socklen addrlen, error
   err) */

error syscall_bind(int s,void *addr,syscall__Socklen addrlen)

{
  ...
  if (local_18 == 0) {
    ...
    if (local_18 < 3) {
      ...
      if (local_18 == 2) goto LAB_005479df;
    }
    else {
