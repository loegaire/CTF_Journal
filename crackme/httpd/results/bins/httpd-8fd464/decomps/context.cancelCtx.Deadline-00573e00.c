...
/* DWARF original prototype: void context.cancelCtx.Deadline(time.Time deadline, bool ok) */

multireturn_time_Time_bool_ context_cancelCtx_Deadline(void)

{
  ...
  mVar2.deadline.wall = (ulong)local_10;
  mVar2.deadline.ext = local_18;
  mVar2.ok = (bool)in_DIL;
  mVar2.deadline.loc = (time_Location *)local_28;
  return mVar2;
}
