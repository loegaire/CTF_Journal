 ...
 static int trang; 
  public static String fourth(String t) {
   ...
   public static String rev4(String t) {
    return t.substring(t.length()-19) + t.substring(0,t.length() - 19);
  }
  ...
  public static String rev2(String t) {
    String a = t.substring(t.length()-trang) + t.substring(0, t.length()-trang);
    return a;
  }
  ...
  public static void main(String[] args) {
    ...
    String th = rev4(rev3(rev2(rev1(match))));
    //System.out.println((first(second(third(fourth(th))))));
    System.out.println(rev1(match));
